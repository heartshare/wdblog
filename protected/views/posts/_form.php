<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'title',array('class'=>'span9','maxlength'=>255,'style'=>'width:100%')); ?>
   ...
   <label for="Posts_post_tags">标签</label>
    ...
    <?php $this->widget('bootstrap.widgets.TbTabs', array(
        ...
        'tabs' => array(
            array('label' => Yii::t('frontend','Excerpt'), 'content' => $form->textAreaRow($model,'excerpt',array('rows'=>4, 'cols'=>50, 'class'=>'span9','style'=>'width:99%')), 'active' => true),
